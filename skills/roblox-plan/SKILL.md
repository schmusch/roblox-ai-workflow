...
- Read the canonical entry points: `docs/README.md` and `docs/AI_HANDOFF.md` to get the latest workspace status and rules.
...
- Read the approved `roblox-blueprint` (`docs/00.2_Gods-and-Icons-Blueprint.md`) if one exists.
- Read the `roblox-brief` (`docs/00.1_Game-Brief.md`) for creator intent.
